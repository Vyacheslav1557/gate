...
const GetMonitor = async (contestId: number) => {
    ...
    try {
        const response = await testerApi.getMonitor(contestId, withBearerAuth(token));
...
const Page = async ({params}: PageProps) => {
    const contestId = parseInt((await params).contest_id, 10);
